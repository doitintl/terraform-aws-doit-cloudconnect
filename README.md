...
| `Reflex`                                          | `reflex`                 | AWS managed policies                  | Read-only deep-dive access for DoiT Reflex: AWS-managed `ReadOnlyAccess` + `AWSSupportAccess` (`SecurityAudit` already attached by core)                                                                                                                              |
